...
if __name__ == '__main__':
    ...
    try:
        ...
        print("motor A forward, speed 100%, Run for 10S")
        m.MotorRun('MA', 'forward', 100)
        print("motor B forward, speed 100%, Run for 10S")
        m.MotorRun('MB', 'forward', 100)
        
        time.sleep(10)
        
        print("motor A backward, speed 100%, Run for 10S, then stop")
        m.MotorRun('MA', 'backward', 100)
        print("motor B backward, speed 100%, Run for 10S, then stop")
        m.MotorRun('MB', 'backward', 100)        
